...
private:
   ...
   ******************************************/
   void dumpHelp(Node *print) const;
   void clearHelp(Node *&move);
   Node* mergeHelp(Node* p1, Node* p2);
   void preOrder(Node* move) const;
   Node* copyHelp(Node* &myRoot, Node* &copyRoot);
};
